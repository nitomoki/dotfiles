...
--- extract highlight from spec.
-- a function that creates new highlight from existed hilight attribute.
...
--@param opts
--@param fn
local wrap_func = function(opts, fn)
...
M.mode = function(opts)
    opts = opts or {}
    return wrap_func(opts, function(_, _)
...
local git_changes_formatter = function(opts)
    ...
    return function(_, _, s)
        ...
        local delim = opts.delim and opts.delim or ", "
